...
const Footer = () => {
    const {social} = footer;
  return (
      <section id='contact' className=' py-[50px] lg:py-[70px] bg-[#23262F] text-white max-w-[990px] mx-auto'>
        <div className="lg:container mx-auto">
            <div className='flex flex-col lg:flex-row justify-between border-b border-opacity-50 border-gray-700 lg:pb-14 pl-8 lg:pl-0 mb-14'>
                <a href="#home" className='mb-6 lg:mb-0 font-bold text-2xl lg:text-5xl'>
                    FurniShop
                </a>
                {/* social  */}
